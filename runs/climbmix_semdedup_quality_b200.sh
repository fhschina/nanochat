...
export SEMD_PAIRWISE_BATCH_SIZE SEMD_EMBEDDING_MAX_CHARS EVAL_EVERY EVAL_TOKENS
export CORE_METRIC_EVERY CORE_METRIC_MAX_PER_TASK FINAL_CORE_MAX_PER_TASK BASE_EVAL_MODES
...
keys = [
    ...
    "SEMD_EMBEDDING_MAX_CHARS", "EVAL_EVERY", "EVAL_TOKENS",
